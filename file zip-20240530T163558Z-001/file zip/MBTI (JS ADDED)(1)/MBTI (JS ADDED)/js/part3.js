...
submitbut.addEventListener("click", () => {
  ...
  if(cauhoihientai < document.getElementById('tongsocauhoi').value){
    ...
    localStorage.setItem('tinhcach3', tinhcach3);
    quiz.innerHTML = `
      <h3>Bạn đã hoàn thành phần 3</h3>
      <button onclick="window.location.href = 'part4.html'">Sang phần 4</button>
    `  
